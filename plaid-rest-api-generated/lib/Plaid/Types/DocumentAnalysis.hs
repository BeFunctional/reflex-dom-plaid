...
module Plaid.Types.DocumentAnalysis ( DocumentAnalysis (..)  ) where
...
import Plaid.Types.DocumentAuthenticityMatchCode
import Plaid.Types.ImageQuality
import Plaid.Types.PhysicalDocumentExtractedDataAnalysis
