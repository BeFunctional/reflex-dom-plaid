...
module Plaid.Types.DepositSwitchAltCreateRequest ( DepositSwitchAltCreateRequest (..)  ) where
...
import Plaid.Types.DepositSwitchTargetAccount
import Plaid.Types.DepositSwitchTargetUser
