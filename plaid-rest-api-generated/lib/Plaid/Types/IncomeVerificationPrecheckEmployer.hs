...
module Plaid.Types.IncomeVerificationPrecheckEmployer ( IncomeVerificationPrecheckEmployer (..)  ) where
...
import Plaid.Types.IncomeVerificationPrecheckEmployerAddress
